...
<script>
  ...
  function addEvent() {
    ...
    if (elements[0].value != "" && elements[1].value != "" && elements[2].value != "") {
      const object = {
        "metoda": "add",
        "image": elements[0].value.substring(12, elements[0].value.length),
        "titlu": elements[1].value,
        "descriere": elements[2].value
      };
  ...
  function deleteEvent(name) {
    ...
    if (raspuns === true) {
      ...
      var object = {
        "metoda": "delete",
        "id": name.substring(9, name.length)
      };
      const xhr = new XMLHttpRequest();
  ...
  function editEvent(nume) {
    ...
    const object = {
      "metoda": "edit",
      "id": nume.substring(9, nume.length),
